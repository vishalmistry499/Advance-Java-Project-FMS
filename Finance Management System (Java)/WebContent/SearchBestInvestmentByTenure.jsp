        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 col-sm-6 col-md-6">
                    <h1 class="text-center">Best Investment Schemes as per Tenure</h1>                  
                   ...
                   <%
				    try
				    {
				        ...
				        ResultSet rs=st.executeQuery("SELECT * FROM `fd_schemes` WHERE Min_Tenure<="+tenure+" ORDER BY Min_Tenure DESC");
				    %>
